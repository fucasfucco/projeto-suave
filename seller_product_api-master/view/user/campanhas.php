...
<body>
    ...
    <div class="row">
        ...
        foreach ($jsonObj as &$product) {
            ...
            echo '<input type="hidden" name="ID" value="' . $product->campaignId . '">';
            echo '<a type="button" class="btn btn-light" style="float: right;" href="campanha.php?ID=' . $product->campaignId . '">Visualizar inteira</a>';
            ...
            foreach ($product->items as &$miniProduct) {
                ...
                echo  '<label class="price "><h3>R$' . $decodificado->price . '</h3></label>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
                unset($miniProduct);
